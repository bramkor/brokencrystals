...
export class AppService {
  ...
  private isValidCommand(exec: string, args: string[]): boolean {
    ...
    const allowedArgs = ['-la', '/etc/passwd'];

    return allowedCommands.includes(exec) && args.every(arg => allowedArgs.includes(arg));
  }
